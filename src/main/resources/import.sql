insert into member (activated, created_at, address, address_detail, zip_code, email, password, phone, user_id, name, id) values (true, now(), '서울시 강남구 테헤란로 427', '아이파크몰 test 호', '00111', 'gildong@commerce.com', '1234', '01012341234', 'test01', '홍길동', 1);
insert into member (activated, created_at, address, address_detail, zip_code, email, password, phone, user_id, name, id) values (true, now(), '서울시 강남구 테스트로 123', '행복아파트 101-101 호', '00112', 'test02@commerce.com', '1234', '01011112222', 'test02', '김테스', 2);
insert into member (activated, created_at, address, address_detail, zip_code, email, password, phone, user_id, name, id) values (true, now(), '서울시 강남구 행복로 123', '즐거운아파트 102-102 호', '00123', 'test03@test.com', '1234', '01011113333', 'test03', '박행복', 3);
